...
from sbi4abm.sbi.inference.new_base import NeuralInference
from sbi4abm.sbi.inference.posteriors import MCMCPosterior, RejectionPosterior, VIPosterior
from sbi4abm.sbi.inference.potentials import ratio_estimator_based_potential
...
class RatioEstimatorForC(NeuralInference, ABC):
    def __init__(
        self,
